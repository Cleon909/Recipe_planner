...
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (1, 1, 1, 100.0, 1);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, ) VALUES (2, 1, 2, 1.0, 3);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (3, 1, 3, 1.0, 3);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (4, 1, 4, 0.5, 3);
INSERT INTO quantity (id, recipe_id, ingredient_id, ingredient_prep, amount, measure) VALUES (5, 1, 5,'cut into 1cm pieces', 1.0, 7);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (6, 1, 6, 1.0, 3);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (7, 1, 7, 1.0, 4);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (8, 1, 8, 1.5, 3);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (9, 1, 9, 1.0, 3);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (10, 1, 10, 400.0, 2);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (11, 1, 11, 1.0, 7);
INSERT INTO quantity (id, recipe_id, ingredient_id, ingredient_prep, amount, measure) VALUES (12, 1, 12, 'roughly chopped', 1.0, 11);
INSERT INTO quantity (id, recipe_id, ingredient_id, amount, measure) VALUES (13, 1, 13, 4.0, 5);
INSERT INTO quantity (id, recipe_id, ingredient_id, ingredient_prep, amount, measure) VALUES (14, 1, 14, 'peeled and roughly chopped', 4.0, 10);

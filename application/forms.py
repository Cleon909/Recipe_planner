...
class AddRecipeForm(FlaskForm):
    ...
    method1 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method2 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method3 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method4 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method5 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method6 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method7 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method8 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method9 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method10 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method11 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method12 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method13 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method14 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
    method15 = StringField('Input method of making the recipe in steps', validators = [Length(max=200)])
